...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-06-2020 a las 02:31:21
...
--
ALTER TABLE `envios`
  ADD CONSTRAINT `Numero` FOREIGN KEY (`Numero`) REFERENCES `provedores​` (`Numero`),
  ADD CONSTRAINT `pNumero` FOREIGN KEY (`pNumero`) REFERENCES `productos` (`pNumero`);
COMMIT;
