...
class Products
{
    ...
    public static function setProduct($tipo, $precio, $stock, $sabor, $foto){
        try {
    ...
    private static function findProductByTipoSabor($tipo, $sabor, $list){
        if ($list != null) {
    ...
    public static function setSale($tipo, $sabor, $email)
    {
        try {
    ...
    public static function getProducts($payload){
        try {
    ...
    public static function getSales($payload){
        try {
